...
import (
	...
	entity "github.com/MatheusBenetti/go-rate-limiter/internal/entity"
...
func (mr *MockcommonRepoMockRecorder) GetBlockedDuration(ctx, key interface{}) *gomock.Call {
...
func (mr *MockcommonRepoMockRecorder) GetRequest(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcommonRepoMockRecorder) SaveBlockedDuration(ctx, key, BlockedDuration interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockcommonRepoMockRecorder) UpsertRequest(ctx, key, rl interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
